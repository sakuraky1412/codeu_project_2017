...
public final class UserPanel extends JPanel {
    ...
    private void initialize() {
        ...
        userListScrollPane.setPreferredSize(new Dimension(150, 95));
        ...
        userInfoScrollPane.setPreferredSize(new Dimension(250, 75));
