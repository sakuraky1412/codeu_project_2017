...
public final class ConversationPanel extends JPanel {
    ...
    private void initialize() {
        ...
        listShowPanel.setLayout(new GridBagLayout());
        ...
        final GridBagConstraints listScrollPanelC = new GridBagConstraints();
        listScrollPanelC.fill = GridBagConstraints.HORIZONTAL;
        listScrollPanelC.weightx = 1;
